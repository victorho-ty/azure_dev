...
# Daemon console app using MSAL Python to get an access token and call Microsoft Graph (client secret variation).
# Certs location: /Users/vichoty/dev/src/azuredev/certs
#   To get SHA1 thumbprint: openssl x509 -noout -fingerprint -sha1 -inform pem -in server.crt
